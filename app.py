    ...
    try:
        ...
        if sys.platform.startswith("win"):
            ...
            camera_configs = [
                ...
                {"dev": "/dev/v4l/by-path/platform-3610000.usb-usb-0:2.1.1:1.0-video-index0", "name": "cam0"},
                {"dev": "/dev/v4l/by-path/platform-3610000.usb-usb-0:2.1.3:1.0-video-index0", "name": "cam1"}
            ]
